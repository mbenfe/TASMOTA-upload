...
# set midnight cron
mycron = string.format("%d 59 23 * * *", cron_second)
...
tasmota.add_cron(mycron, /-> chx.heartbeat(), "every_hour")
mqttprint("cron heartbeat:" + mycron)

mycron = string.format("%d * * * * *", cron_second)
tasmota.add_cron(mycron, /-> chx.every_minute(), "every_minute")
mqttprint("cron minute:" + mycron)