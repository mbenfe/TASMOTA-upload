...
def update()
    ...
    mqttprint("update: " + command)
    tasmota.cmd(command)
        mqttprint("update: getfile pwx4/c3/command.be")
        tasmota.cmd("getfile pwx4/c3/command.be")
        mqttprint("update: getfile pwx4/c3/conso.be")
        tasmota.cmd("getfile pwx4/c3/conso.be")
        mqttprint("update: getfile pwx4/c3/flasher.be")
        tasmota.cmd("getfile pwx4/c3/flasher.be")
        mqttprint("update: getfile pwx4/c3/logger.be")
        tasmota.cmd("getfile pwx4/c3/logger.be")
        mqttprint("update: getfile pwx4/c3/pwx4_driver.be")
        tasmota.cmd("getfile pwx4/c3/pwx4_driver.be")
