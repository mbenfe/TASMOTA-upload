var version = "2.1.0 with xdrv pwx4 legacy"
...
def help()
    ...
    print("[NOTES]")
    print("- UART send link: driver 131 on pins 16/17")
...
def update()
    ...
    fetch_file("pwx4/legacy/berry/pwx4_driver.be")
    mqttprint("update: getfile pwx4/legacy/berry/flasher.be")
    fetch_file("pwx4/legacy/berry/flasher.be")
    mqttprint("update: getfile pwx4/legacy/berry/intelhex.be")
    ...
    mqttprint("update: getfile pwx4/legacy/app/pwx4-flashed.bin")
    fetch_file("pwx4/legacy/app/pwx4-flashed.bin")
    mqttprint("update: getfile pwx4/legacy/boot/F412-bootloader.bin")
    fetch_file("pwx4/legacy/boot/F412-bootloader.bin")
    mqttprint("update: getfile pwx4/legacy/boot/F412-bootloader.hex")
    fetch_file("pwx4/legacy/boot/F412-bootloader.hex")
    mqttprint("update: getfile pwx4/legacy/app/pwx4-flashed.bin")
    fetch_file("pwx4/legacy/app/pwx4-flashed.bin")
    mqttprint("update: getfile pwx4/legacy/app/pwx4-flashed.hex")
    fetch_file("pwx4/legacy/app/pwx4-flashed.hex")
