...
def update()
    ...
    mqttprint("update: getfile pwx4/legacy/app/pwx4legacy-flashed.bin")
    fetch_file("pwx4/legacy/app/pwx4legacy-flashed.bin")
    ...
    mqttprint("update: getfile pwx4/legacy/app/pwx4legacy-flashed.bin")
    fetch_file("pwx4/legacy/app/pwx4legacy-flashed.bin")
    mqttprint("update: getfile hex/pwx4legacy-flashed.hex")
    fetch_file("hex/pwx4legacy-flashed.hex")
