...
def Init()
    ...
    global.serSend = serial(rxSend, txSend, 921600, serial.SERIAL_8N1)
...
def help()
    ...
    print("- update downloads: c_<ville>.json, p_<ville>.json, conso.be, pwx12_driver.be")
    print("- autoexec.be must be refreshed separately")
    tasmota.resp_cmnd_done()
end
...
def update()
    ...
    mqttprint("update: " + command)
    tasmota.cmd(command)
    mqttprint("update: getfile pwx12/berry-legacy/berry/conso.be")
    tasmota.cmd("getfile pwx12/berry-legacy/berry/conso.be")
    mqttprint("update: getfile pwx12/berry-legacy/berry/pwx12_driver.be")
    tasmota.cmd("getfile pwx12/berry-legacy/berry/pwx12_driver.be")
    mqttprint("update: getfile pwx12/berry-legacy/berry/autoexec.be")
    tasmota.cmd("getfile pwx12/berry-legacy/berry/autoexec.be")
    start()
