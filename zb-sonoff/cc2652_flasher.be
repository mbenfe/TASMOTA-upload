...
class cc2652_flasher
  ...
  def init(rx, tx, rst, bsl)
    ...
    print("FLH: cc2652_flasher initialized")
  end

  # restart the MCU in BSL mode and establish communication
  def start(debug)
    print("FLH: cc2652_flasher function start called")
    if debug == nil    
        print("FLH: cc2652_flasher function start debug is nil")
        debug = false 
    end
    print("FLH: cc2652_flasher function start debug=", debug)
    self.debug = bool(debug)
    print("FLH: cc2652_flasher function start debug=", self.debug)
    self.reset_bsl()
    #
    print("FLH: cc2652_flasher function start completed")
  end
  ...
  #  ser: serial object
  def reset_bsl()
    print("FLH: cc2652_flasher function reset_bsl called")
    self.ser.flush()
    print("FLH: cc2652_flasher function reset_bsl flushed")

    gpio.digital_write(self.bsl, 0)    # trigger BSL
    print("FLH: cc2652_flasher function reset_bsl BSL triggered")
    ...
    print("FLH: cc2652_flasher function reset_bsl I/O reset")
